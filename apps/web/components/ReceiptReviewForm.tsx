...
export interface ReceiptReviewFormProps {
  /** Extracted data from the scan-receipt endpoint */
  initialValues: ScanReceiptResponse
  /** Parent owns the actual apiMutate call — same POST /api/transactions flow */
...
export default function ReceiptReviewForm({
  ...
  const [kategoriId, setKategoriId] = useState(
    initialValues.suggested_category_id ?? ''
  )
