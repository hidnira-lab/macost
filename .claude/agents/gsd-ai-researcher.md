...
<required_reading>
Read `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
