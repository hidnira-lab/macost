...
**Verification depth scales with `asvs_level`** (see @C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
