...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/.gsd-surface.json`
(sibling to `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/skills`).
...
`C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/.gsd-surface.json`
Install profile marker: `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/.gsd-profile`
Skill dirs: `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/skills/gsd-*/`
Engine module: `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
