...
The keys live in `.claude/settings.json` (project) or `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/settings.json` (global) — **not** in `.planning/config.json`:
