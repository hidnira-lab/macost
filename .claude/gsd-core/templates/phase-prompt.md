...
<!-- For checkpoint task examples and patterns, see @C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/gsd-core/references/checkpoints.md -->
...
See `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
