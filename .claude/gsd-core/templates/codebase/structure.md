...
- Usage: Reference from command with `@C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
