...
```
Agent(
  prompt="Read C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/gsd-core/templates/SECURITY.md`
