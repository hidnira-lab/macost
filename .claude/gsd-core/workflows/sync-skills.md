...
INSTALL_JS_GLOBAL="C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/hiday/WebstormProjects/Zephyra/macost/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
